...
# modified by OpenPanel:
# - index on id="" while parsing (peter)
#   most of the other stuff is broken now, though
...
class Seeder(EntityResolver, DTDHandler, ContentHandler, ErrorHandler):
	...
	def startElementNS(self, name, qname, attrs):
		...
		self.stack.append(Element(id, attrs, prefixes=newprefixes.copy()))
...
def unittest():
	raise "NoTestingError", "we're sorry, we broke the unittest for now."
